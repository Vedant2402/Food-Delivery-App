...
function Meat() {
  const items = [
    ...
    { id: 4, name: "Pork Chops", weight: "1kg", price: 10.99, image: "https://images.unsplash.com/photo-1602491453631-e2a5ad90a131?auto=format&fit=crop&w=800&q=80" },
    { id: 5, name: "Lamb Chops", weight: "500g", price: 16.99, image: "https://images.unsplash.com/photo-1603360946369-dc9bb6f54262?auto=format&fit=crop&w=800&q=80" },
    { id: 6, name: "Sausages", weight: "500g", price: 6.99, image: "https://images.unsplash.com/photo-1585325701165-351af916e581?auto=format&fit=crop&w=800&q=80" },
    ...
    { id: 8, name: "Turkey Breast", weight: "1kg", price: 11.99, image: "https://images.unsplash.com/photo-1612203985729-70726954388c?auto=format&fit=crop&w=800&q=80" },
  ];
