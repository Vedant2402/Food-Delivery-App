...
function Bakery() {
  const items = [
    { id: 1, name: "Sourdough Bread", weight: "1pc", price: 4.99, image: "https://images.unsplash.com/photo-1585476644321-b970d1174d89?auto=format&fit=crop&w=800&q=80" },
    ...
    { id: 3, name: "Bagels", weight: "6pcs", price: 3.99, image: "https://images.unsplash.com/photo-1585476644321-b970d1174d89?auto=format&fit=crop&w=800&q=80" },
    ...
    { id: 8, name: "Cookies", weight: "12pcs", price: 5.49, image: "https://images.unsplash.com/photo-1499636138143-bd630f5cf38a?auto=format&fit=crop&w=800&q=80" },
  ];
